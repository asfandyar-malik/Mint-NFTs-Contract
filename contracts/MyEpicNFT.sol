...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Aeneias", "Epic", "Legend", "Crazy", "Wild", "Terryfying"];
  string[] secondWords = ["Cupcake", "Pizza", "Chris", "Julian", "Chicken", "Mik"];
  string[] thirdWords = ["Yasin", "Sasuke", "King", "Jannik", "Champ", "Minato"];
